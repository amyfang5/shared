...
if("FALSE" STREQUAL "TRUE")
  set(dynamixel_workbench_toolbox_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-dynamixel-workbench-toolbox-0.1.0)
  set(dynamixel_workbench_toolbox_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-dynamixel-workbench-toolbox-0.1.0/obj-x86_64-linux-gnu/devel)
  ...
  set(dynamixel_workbench_toolbox_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_workbench_toolbox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
