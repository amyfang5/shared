...
if("FALSE" STREQUAL "TRUE")
  set(freenect_camera_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-freenect-camera-0.4.2)
  set(freenect_camera_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-freenect-camera-0.4.2/obj-x86_64-linux-gnu/devel)
  ...
  set(freenect_camera_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'freenect_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Piyush Khandelwal <piyushk@gmail.com>' to fix it.")
    endif()
