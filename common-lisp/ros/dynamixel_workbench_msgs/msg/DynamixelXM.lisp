...
(cl:defclass <DynamixelXM> (roslisp-msg-protocol:ros-message)
  ((model_number
   ...
   (velocity_p_gain
    ...
    :initform 0)
   (velocity_d_gain
    :reader velocity_d_gain
    :initarg :velocity_d_gain
    :type cl:integer
    :initform 0)
   (position_i_gain
...
(cl:ensure-generic-function 'velocity_d_gain-val :lambda-list '(m))
(cl:defmethod velocity_d_gain-val ((m <DynamixelXM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_workbench_msgs-msg:velocity_d_gain-val is deprecated.  Use dynamixel_workbench_msgs-msg:velocity_d_gain instead.")
  (velocity_d_gain m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DynamixelXM>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'velocity_d_gain)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamixelXM>) istream)
  "Deserializes a message object of type '<DynamixelXM>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'velocity_d_gain) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelXM>)))
  ...
  "0b0539c04a36cbb68a40fce082414129")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelXM)))
  "Returns md5sum for a message object of type 'DynamixelXM"
  "0b0539c04a36cbb68a40fce082414129")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelXM>)))
  ...
  (cl:format cl:nil "int64 model_number~%int64 version_of_firmware~%int8  id~%int64 baud_rate~%int64 return_delay_time~%int64 operating_mode~%int64 protocol_version~%int64 homing_offset~%int64 moving_threshold~%int64 max_temperature_limit~%int64 max_voltage_limit~%int64 min_voltage_limit~%int64 pwm_limit~%int64 current_limit~%int64 acceleration_limit~%int64 velocity_limit~%int64 max_position_limit~%int64 min_position_limit~%int64 shutdown~%bool  torque_enable~%bool led~%int64 status_return_level~%int64 registered_instruction~%int64 hardware_error_status~%int64 velocity_i_gain~%int64 velocity_p_gain~%int64 velocity_d_gain~%int64 position_i_gain~%int64 position_p_gain~%int64 feedforward_2nd_gain~%int64 feedforward_1st_gain~%int64 goal_pwm~%int64 goal_current~%int64 goal_velocity~%int64 profile_acceleration~%int64 profile_velocity~%int64 goal_position~%int64 realtime_tick~%bool moving~%int64 moving_status~%int64 present_pwm~%int64 present_current~%int64 present_velocity~%int64 present_position~%int64 velocity_trajectory~%int64 position_trajectory~%int64 present_input_voltage~%int64 present_temperature~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelXM)))
  "Returns full string definition for message of type 'DynamixelXM"
  (cl:format cl:nil "int64 model_number~%int64 version_of_firmware~%int8  id~%int64 baud_rate~%int64 return_delay_time~%int64 operating_mode~%int64 protocol_version~%int64 homing_offset~%int64 moving_threshold~%int64 max_temperature_limit~%int64 max_voltage_limit~%int64 min_voltage_limit~%int64 pwm_limit~%int64 current_limit~%int64 acceleration_limit~%int64 velocity_limit~%int64 max_position_limit~%int64 min_position_limit~%int64 shutdown~%bool  torque_enable~%bool led~%int64 status_return_level~%int64 registered_instruction~%int64 hardware_error_status~%int64 velocity_i_gain~%int64 velocity_p_gain~%int64 velocity_d_gain~%int64 position_i_gain~%int64 position_p_gain~%int64 feedforward_2nd_gain~%int64 feedforward_1st_gain~%int64 goal_pwm~%int64 goal_current~%int64 goal_velocity~%int64 profile_acceleration~%int64 profile_velocity~%int64 goal_position~%int64 realtime_tick~%bool moving~%int64 moving_status~%int64 present_pwm~%int64 present_current~%int64 present_velocity~%int64 present_position~%int64 velocity_trajectory~%int64 position_trajectory~%int64 present_input_voltage~%int64 present_temperature~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DynamixelXM>))
  ...
  (cl:list 'DynamixelXM
    ...
    (cl:cons ':velocity_d_gain (velocity_d_gain msg))
