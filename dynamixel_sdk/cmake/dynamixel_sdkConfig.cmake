...
if("FALSE" STREQUAL "TRUE")
  set(dynamixel_sdk_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-dynamixel-sdk-3.4.1)
  set(dynamixel_sdk_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-dynamixel-sdk-3.4.1/obj-x86_64-linux-gnu/devel)
  ...
  set(dynamixel_sdk_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
